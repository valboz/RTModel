# RTModel
`RTModel` is a package for modeling and interpretation of microlensing events ([here is an introduction for novices](https://www.microlensing-source.org/)). It uses photometric and/or astrometric time series collected from ground and/or space telescopes to propose one or more possible models among the following:

- **v2.2** - 2024/10/? - Replaced VBBinaryLensing with VBMicrolensing; Added the possibility to constrain fits;  possibility to choose model categories to fit; possibility to make just a quick update to previously found models; partial implementation of three more models: Keplerian orbital motion for binary lenses, static triple-lenses, triple-lenses with parallax.
